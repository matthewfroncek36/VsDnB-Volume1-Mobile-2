...
void main () {
	...
	vec4 finalRGB;
	finalRGB.r = dither8x8(gl_FragCoord.xy, rgba.r);
	finalRGB.g = dither8x8(gl_FragCoord.xy, rgba.g);
	finalRGB.b = dither8x8(gl_FragCoord.xy, rgba.b);
	finalRGB.a = dither8x8(gl_FragCoord.xy, rgba.a);
