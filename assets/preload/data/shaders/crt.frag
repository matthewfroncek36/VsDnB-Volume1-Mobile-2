...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    col.r = texture(iChannel0,vec2(x+uv.x+0.0005,uv.y+0.0005)).x+0.05;
    col.g = texture(iChannel0,vec2(x+uv.x+0.000,uv.y-0.001)).y+0.05;
    col.b = texture(iChannel0,vec2(x+uv.x-0.001,uv.y+0.000)).z+0.05;
